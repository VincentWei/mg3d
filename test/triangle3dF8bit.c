	...
	case MSG_PAINT:
            ...
            switch (render_type[render_mode])
	   {
	    ...
	    if (poly_count == 0)break;
	        mg3dTriangleF(mem_dc,  render_type[poly_info[poly_count-1].type], texture, poly_info[poly_count-1].vtx[0], poly_info[poly_count-1].vtx[1], poly_info[poly_count-1].vtx[2]);
