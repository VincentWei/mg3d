/*
** $Id: cdefs15.h,v 1.2 2006-01-14 05:44:14 xwyan Exp $
**
...
#define PUT_PIXEL(p,c)         bmp_write15((unsigned long) (p), (c))
#define PUT_MEMORY_PIXEL(p,c)  (*(p) = (c))
#define PUT_RGB(p,mem_dc,r,g,b)       bmp_write15((unsigned long) (p), RGB2Pixel((mem_dc), (r), (g), (b)))
#define GET_PIXEL(p)           bmp_read15((unsigned long) (p))
